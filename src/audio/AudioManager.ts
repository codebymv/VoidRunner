...
export class AudioManager {
  ...
  // Volume levels
  private readonly MENU_VOLUME = 0.05; // 5% - Very subtle background music
  private readonly GAMEPLAY_VOLUME = 0.06; // 6% - Lowered further for better gameplay audio balance
